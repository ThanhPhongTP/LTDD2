...
public class Round4_lv2Activity extends AppCompatActivity {
...
//                            Intent intent = new Intent(Round4_lv2Activity.this, Main3Activity.class);
...
//                            timer.start();
    ...
    private void setConTrol() {
        ...
        int diemKQ = mydata.getInt("diem4");
...
//
        demthoigian = new CountDownTimer(60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                String giophutgiay = String.format("Time :%02d", giay);
...
//                edit.commit();
    ...
    private  void gameOver(){
        ...
        alertDialogBuilder.setPositiveButton("Chơi lại", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(Round4_lv2Activity.this, ThongBaoActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                int diemKQ = Integer.parseInt(txtDiem.getText().toString());
                intent.putExtra("diem4_1", diemKQ);
                startActivity(intent);
                arg0.dismiss();
    ...
    public void youWin() {
        ...
        alertDialogBuilder.setIcon(R.drawable.iconcuoi);
        final Intent intent = new Intent(Round4_lv2Activity.this, ThongBaoActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        int diemKQ = Integer.parseInt(txtDiem.getText().toString());
        intent.putExtra("diem4_1", diemKQ);
        startActivity(intent);
...
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//                final Intent intent = new Intent(Round4_lv2Activity.this, Round4_lv2Activity.class);
//                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
//                startActivity(intent);
//            }
//        });
