...
public class Round3Activity extends AppCompatActivity {
    ...
    Button Mau1, Mau2, Mau3, Mau4, Mau5, Mau6;
    ...
    private void setEvent() {
        ...
        RandomMau(Mau5);
        RandomMau(Mau6);
        RandomMauSai(Mau1, Mau2, Mau3, Mau4, Mau5, Mau6);
    }
    ...
    private void RandomMauSai(Button btn1, Button btn2, Button btn3, Button btn4, Button btn5, Button btn6){
