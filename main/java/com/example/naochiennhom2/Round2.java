...
public class Round2 extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        timer = new CountDownTimer(60000,1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Round2.this, HD3Activity.class);
    ...
    private void checkEnd() {
        AlertDialog.Builder alerdialogbuilder = new AlertDialog.Builder(Round2.this);
    ...
    public void byExtras(){
        Intent intent = new Intent(Round2.this, ThongBaoActivity.class);
